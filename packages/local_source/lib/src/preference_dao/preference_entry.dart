...
abstract base class PreferenceDao {
  ...
  /// Creates a preference entry for storing and retrieving a [List<String>] value.
  PreferenceEntry<List<String>> stringListEntry({required String key}) =>
      _PreferenceEntry<List<String>>(sharedPreferences: _sharedPreferences, key: key);
